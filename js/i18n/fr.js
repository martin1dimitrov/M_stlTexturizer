export default {
  ...
  "license.item3": "Soutenir cet outil ? Achetez sur <a href=\"https://geni.us/CNCStoreTexture\" target=\"_blank\" rel=\"noopener\">CNCKitchen.STORE</a> ou faites un don sur <a href=\"https://www.paypal.me/CNCKitchen\" target=\"_blank\" rel=\"noopener\">PayPal</a> / <a href=\"https://ko-fi.com/cnckitchen\" target=\"_blank\" rel=\"noopener\">Ko-fi</a>.",
  ...
  "cta.store": "Soutenir cet outil ? Visitez <a href=\"https://geni.us/CNCStoreTexture\" target=\"_blank\" rel=\"noopener\">CNCKitchen.STORE</a> ou faites un don sur <a href=\"https://www.paypal.me/CNCKitchen\" target=\"_blank\" rel=\"noopener\">PayPal</a> / <a href=\"https://ko-fi.com/cnckitchen\" target=\"_blank\" rel=\"noopener noreferrer\">Ko-fi</a>",
  ...
  "diag.show": "Afficher",
  "diag.hide": "Masquer",
  "textureValidation.strongColor": "Texture appears to be strongly colored; use a grayscale displacement map.",
  "textureValidation.notGrayscale": "Texture is not purely grayscale. Converting to grayscale is recommended.",
  "textureValidation.lowContrast": "Low contrast histogram; displacement may look flat.",
  "textureValidation.clipping": "Histogram clipping detected; details may crush at min/max height.",
  "textureValidation.seamMismatch": "High seam mismatch score; tiling seams may be visible.",
  "textureValidation.headlineOk": "✓ Texture quality check passed.",
  "textureValidation.headlineWarn": "⚠ Texture quality warnings.",
  "textureValidation.headlineError": "⛔ Texture rejected.",
  "textureValidation.metrics": "Gray Δ {gray} · Range {range} · Seam {seam}",
  "textureValidation.ready": "Ready for displacement.",
  "exportValidation.vaseNeedsCylindrical": "Vase Workflow Safeguards require Cylindrical mapping. Set Projection → Cylindrical for Spiral Vase exports.",
  "exportValidation.vaseValidationUnavailable": "Vase validation could not run. Load a displacement map and keep Cylindrical mapping enabled for Spiral Vase compatibility checks.",
  "exportValidation.vaseSeamUnsafe": "Spiral Vase seam continuity is unsafe. Reduce Transition Smoothing or lower texture Scale U to keep the seam band continuous.",
  "exportValidation.vaseHighFrequency": "Circumferential detail is too high-frequency for reliable Spiral Vase walls. Increase texture smoothing or use a softer map.",
  "exportValidation.vaseRadialRisk": "Radial reversal risk detected ({bands} bands, max {mm} mm inward). Reduce amplitude or enable symmetric displacement for Spiral Vase.",
  "exportValidation.estimatePre": "~{n} tris pre-decimation",
  "exportValidation.estimatePost": "{n} post",
  "exportValidation.estimatePeakMemory": "{n} MB peak",
  "exportValidation.estimatePrefix": "≈"
};
